create table users(id SERIAL PRIMARY KEY,name varchar(50),email varchar(50),password varchar(100),active_sessions int DEFAULT 0,tfa boolean default false);
