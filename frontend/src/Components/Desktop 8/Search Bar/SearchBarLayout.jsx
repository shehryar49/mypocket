  ...
  return (
    <div className="flex justify-center items-center flex-grow mt-6 w-full">
      <div className="relative w-80 md:w-2/3 lg:w-1/2">
        ...
        <div className="flex items-center bg-gray-200 dark:bg-gray-600 dark:focus-within:bg-gray-700 dark:shadow-sm dark:shadow-gray-400 rounded-full shadow-md focus-within:ring-2 focus-within:bg-blue-100 focus-within:ring-blue-400 transition">
          {/* Search Icon */}
          <RiSearch2Line
            ...
            {filteredSearch.length === 0 ? (
              ...
              <ul className="max-h-60 overflow-y-auto">
                {filteredSearch.map((data, index) => (
                  <li
                    key={index}
                    className="flex justify-between dark:text-gray-200 dark:hover:bg-blue-600 cursor-pointer items-center p-3 hover:bg-blue-100 text-sm text-gray-700 transition duration-200"
                  >
